...
<body>
    ...
    <header>
      ...
      <li class="nav-item">
              <a class="nav-link" href="inputdatasiswa.php">Input Data Siswa</a>
            </li>
            <li class="nav-item">
 ...
 <form method="post" action='prsupdate.php?id=<?php echo $siswa['id']; ?>'>
<div class="container">
...
<button type="submit" name="update" class="btn btn-primary btn-block">Perbaharui Data</button>
