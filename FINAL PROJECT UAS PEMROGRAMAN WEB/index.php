<!DOCTYPE HTML>  
 <html>  
 <head>  
      <title>Login Guru dan Murid</title>  
   <meta charset="utf-8">
 ...
 <div class="jumbotron text-center" style="padding-top: 8%; padding-bottom: 8%">  
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                  ...
                  <p class="text-center"> Berikut ini adalah beberapa info mengenai yang sedang terjadi di sekolah</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <a href=".php" class="btn btn-success">Selengkapnya</a>  
                    </div>
