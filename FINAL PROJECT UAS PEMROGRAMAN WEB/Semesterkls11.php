<?php include("koneksi2.php"); ?>  
 ...
 <table class="table table-bordered table-hover">  
  <center><a href="halamanmurid11.php" class="btn btn-outline-success">Kembali</a></center>
   <thead>  
     <tr>  
       <th>No</th>
       <th>Semester</th>
   ...
   <tbody>  
     ...
     <?php  
     $sql = "SELECT * FROM tabelkelas11 where semester='1' && nama='Ananda Lakunti' ";  
 ...
 <table class="table table-bordered table-hover">  
   ...
   <tbody>  
     ...
     <?php  
    $sql = "SELECT * FROM tabelkelas11 where semester='2' && nama='Ananda Lakunti' "; 
     $query = mysqli_query($db, $sql);  
     while($siswa = mysqli_fetch_array($query)){  
       echo "<tr>";  
       echo "<td>".$siswa['id']."</td>";  
...
<div class="table-responsive">  
 <table class="table table-bordered table-hover">  
   ...
   <tbody>  
     ...
     <?php  
     $sql = "SELECT * FROM tabelkelas11 where semester='3' && nama='Ananda Lakunti' ";   
     $query = mysqli_query($db, $sql);  
     while($siswa = mysqli_fetch_array($query)){  
       echo "<tr>";  
       echo "<td>".$siswa['id']."</td>";  
...
<div class="jumbotron text-center" style="padding-top: 10%; padding-bottom: 10%;">  
 ...
 <table class="table table-bordered table-hover">  
   ...
   <tbody>  
     ...
     <?php  
     $sql = "SELECT * FROM tabelkelas11 where semester='4' && nama='Ananda Lakunti' ";   
     $query = mysqli_query($db, $sql);  
     while($siswa = mysqli_fetch_array($query)){  
       echo "<tr>";  
       echo "<td>".$siswa['id']."</td>";  
...
<div class="jumbotron text-center" style="padding-top: 10%; padding-bottom: 10%;">  
 ...
 <table class="table table-bordered table-hover">  
   ...
   <tbody>  
     ...
     <?php  
     $sql = "SELECT * FROM tabelkelas11 where semester='5' && nama='Ananda Lakunti' ";  
     $query = mysqli_query($db, $sql);  
     while($siswa = mysqli_fetch_array($query)){  
       echo "<tr>";  
       echo "<td>".$siswa['id']."</td>";  
