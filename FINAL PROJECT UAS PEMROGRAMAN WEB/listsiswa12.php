<?php include("koneksi2.php"); ?>  
 ...
 <header>
      ...
      <li class="nav-item">
              <a class="nav-link" href="inputdatasiswa12.php">Input Nilai Siswa</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="listsiswa12.php">Lihat List Siswa Kelas Anda</a>
            </li>
          </ul>
    ...
    <div class="jumbotron text-center" style="padding-top: 10%; padding-bottom: 10%;">  
           <h1>Selamat Datang Guru Kelas 12</h1>  
   ...
   <tbody>  
     ...
     while($siswa = mysqli_fetch_array($query)){  
      ...
      echo "<td>".$siswa['hasil']."</td>"; 
       ...
       echo "<td>"; 
       echo "<a href='inputdatasiswa12.php?id=".$siswa['id']."' class='btn btn-info'>Edit</a>  ";
           echo "</td>";
           echo "<td>";
       echo "<a href='prshps1.php?id=".$siswa['id']."' class='btn btn-danger'>Hapus</a>  ";   
       echo "</td>";  
       echo "</tr>";  
     }  
     ?>  
    ...
    <nav class="text-center">  
     <a href="inputdatasiswa12.php" class="btn btn-success">[+] Tambah Baru</a>  
   </nav> 
   <br>
 </table>  
