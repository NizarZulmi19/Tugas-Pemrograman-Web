<?php include("koneksi2.php"); ?>  
 ...
 <header>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="halamanguru.php">Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
      ...
      <li class="nav-item">
              <a class="nav-link" href="inputdatasiswa.php">Input Nilai Siswa</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="listsiswa.php">Lihat List Siswa Kelas Anda</a>
            </li>
          </ul>
    ...
    <div class="jumbotron text-center" style="padding-top: 10%; padding-bottom: 10%;">  
           <h1>Selamat Datang Guru Kelas 10</h1>  
 ...
 <table class="table table-bordered table-hover">  
   ...
   <tbody>  
     ...
     while($siswa = mysqli_fetch_array($query)){  
      ...
      echo "<td>".$siswa['hasil']."</td>"; 
       ...
       echo "<td>"; 
       echo "<a href='halamanupdate10.php?id=".$siswa['id']."' class='btn btn-info'>Edit</a>  ";
           echo "</td>";
           echo "<td>";
       echo "<a href='prshps.php?id=".$siswa['id']."' class='btn btn-danger'>Hapus</a>  ";   
       echo "</td>";  
       echo "</tr>";  
     }  
     ?>  
   ...
   <nav class="text-center">  
     <a href="inputdatasiswa.php" class="btn btn-success">[+] Tambah Baru</a>  
