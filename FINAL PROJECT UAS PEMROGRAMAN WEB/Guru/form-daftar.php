 ...
 <body>  
  <header>
      ...
      <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="data-list-guru.php">Seluruh List Guru SMA Tadika Mesra</a>
            </li>
          </ul>
      ...
      <script type="text/javascript">  
           function insertData(){  
                ...
                var school = document.getElementById("nomor").value;  
      ...
      <header>  <br><br>
           <h3 class="jumbotron text-center">Input Data Guru </h3>  
      </header>  
      <div class="container">       
           <form action="proses-pendaftaran.php" style="padding-left: 25%;">  
                <div class="row">            
                ...
                <div class="row">            
                     <div class="form-group col-md-8">                 
                    <label for="sekolah_asal">Nomor Telp </label>  
                    <input class="form-control" type="text" id="nomor" placeholder="No Telp" />  
                     </div>  
                </div>  
                <div class="form-group">            
               <input type="button" class="btn btn-primary" value="Tambah Data " name="daftar" onclick="insertData()" />  
