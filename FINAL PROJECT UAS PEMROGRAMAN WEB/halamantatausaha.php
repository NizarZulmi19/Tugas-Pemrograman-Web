<!DOCTYPE HTML>  
  ...
  <header>
      ...
      <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="TU/data-list-siswa.php">Data Nama Seluruh Siswa</a>
             
              <a class="dropdown-item" href="Guru/data-list-guru.php">Data List Guru</a>
              
              
            </div>
      </li>
      <li class="nav-item">
              <a class="nav-link" href="TU/form-daftar.php">Input Data Siswa</a>
            </li>
 ...
 <div class="jumbotron text-center" style="padding-top: 20%; padding-bottom: 15%;">  
