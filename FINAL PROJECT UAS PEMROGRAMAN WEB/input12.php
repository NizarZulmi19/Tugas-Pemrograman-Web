...
$sql = mysqli_query($conn,"INSERT INTO tabelkelas12 (semester,nama,agama,pkn,bhsindo,matematika,bhsing,senibudaya,penjas,catatanwali,sakit,izin,tanpaket,hasil) VALUES ('$semester','$nama','$agama','$pkn','$bhsindo','$matematika', '$bhsing','$senibudaya','$penjas','$catatanwali','$sakit','$izin','$tanpaket','$hasil')");
if ($sql) {
