   ...
   <tbody>  
     ...
     while($siswa = mysqli_fetch_array($query)){  
      ...
      echo "<td>".$siswa['hasil']."</td>"; 
       ...
       echo "<td>"; 
       echo "<a href='inputdatasiswa11.php?id=".$siswa['id']."' class='btn btn-info'>Edit</a>  ";
           echo "</td>";
           echo "<td>";
    ...
    <nav class="text-center">  
     <a href="inputdatasiswa11.php" class="btn btn-success">[+] Tambah Baru</a>  
   </nav> 
   <br>
 </table>  
